...
export const Home = () => {
  ...
  const getStaffers = async () => {
    await axios.get(BASE_URL + '/user/get/staffers')
      .then(response => { console.log(response.data); setStaffers(response.data) })
  ...
  return (
    <div className="justify-around flex h-screen w-screen bg-[#242a33]">
      <div className='bodyhome flex'>
        <div>
        {
          newses.map(iterationNews => (
            <div style={{ maxWidth: 1040 }} className='mt-14 pr-20'>
              <div style={{ fontFamily: 'League Spartan', height: 64 }} className='pl-10 pr-10 font-bold flex items-center text-[#ffffff] bg-[#262D37]'>
                <div>
                  ...
                  <h2 className='text-[gray]'>{iterationNews.created_on.substring(0,15)}</h2>
                </div>
              </div>
              <div className='mt-4 flex p-10 bg-[#262D37]'>
                ...
                <div className='p-10'>
                  <h4 className='text-[#ffffff]' style={{ fontFamily: 'League Spartan' }}>{iterationNews.body}</h4>
                </div>
              </div>
            </div>
          ))
        ...
        <div>
          <div style={{ minHeight: 154, borderRadius: 10, width: 284 }} className='h-auto bg-[#262D37]'>
